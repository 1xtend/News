...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class='card' style='width: 100%;'>\r\n  <div class='card-body'>\r\n    <h5 class='card-title'>"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"author") || (depth0 != null ? lookupProperty(depth0,"author") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"author","hash":{},"data":data,"loc":{"start":{"line":4,"column":46},"end":{"line":4,"column":56}}}) : helper)))
    + "</h6>\r\n    <a href='"
    + alias4(((helper = (helper = lookupProperty(helpers,"url") || (depth0 != null ? lookupProperty(depth0,"url") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data,"loc":{"start":{"line":5,"column":13},"end":{"line":5,"column":20}}}) : helper)))
    + "' class='card-link' target='_blank'>View full post</a>\r\n  </div>\r\n</div>";
},"useData":true});
...
/* harmony import */ var _partials_hit_hbs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./partials/hit.hbs */ "./src/partials/hit.hbs");
/* harmony import */ var _partials_hit_hbs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_partials_hit_hbs__WEBPACK_IMPORTED_MODULE_1__);
...
function fetchNews() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].get('https://hn.algolia.com/api/v1/search', {
    params: {
      query: query,
      page: page,
      tags: 'story',
    ...
    res.data.hits.forEach(function (hit) {
      var hitHtml = _partials_hit_hbs__WEBPACK_IMPORTED_MODULE_1___default()(hit);
      html += hitHtml;
    });
    refs.newsList.innerHTML += html;
    refs.resultsCount.textContent = numeral__WEBPACK_IMPORTED_MODULE_2___default()(res.data.nbHits).format('0a');
